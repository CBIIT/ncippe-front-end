...
const AddConsent = (props) => {
  ...
  return (
    <form id="activatePatient" sx={{ mt: 2 }} autoComplete="off" onSubmit={handleFormSubmit}>
      ...
      {!addParticipantContext.file && (
        <label htmlFor="report-upload-file">
          <Button sx={{ my: 3, textTransform: 'none',fontWeight: 600, fontFamily: '"Open Sans", sans-serif', }} variant="outlined" color="primary" component="span">{t('form.consentFile')}</Button>
        </label>
      )}
