        ...
        <Box mt={5}>
          <Grid container className={classes.grid} spacing={2} direction="row" justify="center" alignItems="stretch">
            <Grid className={classes.gridItem} item xs={12} sm={6}>
              <Typography gutterBottom>The Cancer Moonshot Biobank will start out by collecting samples from patients with specific types of cancer, who are being treated at participating hospitals. Other cancer types and more hospitals may be added in future phases of the Biobank program.</Typography>
              <Typography variant="h2" component="h2">Eligibility</Typography>
              <Typography variant="h3" component="h3">You may be eligible if you:</Typography>
            ...
            <Grid className={classes.gridItem} item xs={12} sm={6}>
              <img src={`${process.env.PUBLIC_URL}assets/images/patient.jpg`} alt="reassuring hands" />
            </Grid>
            <Divider className={classes.divider} />
            <Grid className={classes.gridItem} item xs={12} sm={6}>
              <Typography variant="h2" component="h2">Participating hospitals</Typography>
              <Typography variant="body2">To participate in the Biobank, you must be in the care of a doctor at one of these hospitals.</Typography>
            ...
            <Grid className={classes.gridItem} item xs={12} md={8}>
              <Typography variant="h2" component="h2">Not eligible? Join another study</Typography>
              <Typography component="div">If you can't join the Cancer Moonshot Biobank, consider making a difference by participating in projects at NIH or NCI.
              <ul className="bulletList bulletList--spreadOut">
