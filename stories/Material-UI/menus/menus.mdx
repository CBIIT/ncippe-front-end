...
<Example path="Material-UI/menus/examples/SimpleMenu" />
...
<Example path="Material-UI/menus/examples/SimpleListMenu" />
...
<Example path="Material-UI/menus/examples/MenuListComposition" />
...
<Example path="Material-UI/menus/examples/CustomizedMenus" />
...
<Example path="Material-UI/menus/examples/LongMenu" />
...
<Example path="Material-UI/menus/examples/TypographyMenu" />

## Change transition

Use a different transition.

<Example path="Material-UI/menus/examples/FadeMenu" />
...
<Example path="Material-UI/menus/examples/MenuPopupState" />
