...
<Example path="Material-UI/button/examples/ContainedButtons" />
...
<Example path="Material-UI/button/examples/TextButtons" />
...
<Example path="Material-UI/button/examples/OutlinedButtons" />

## Grouped Buttons

The ButtonGroup component can be used to group outlined (the default) or contained buttons.

<Example path="Material-UI/button/examples/GroupedButtons" />
...
<Example path="Material-UI/button/examples/SplitButtons" />
...
<Example path="Material-UI/button/examples/FloatingActionButtons" />
...
<Example path="Material-UI/button/examples/ButtonSizes" />

## Buttons with icons and label

Sometimes you might want to have icons for certain button to enhance the UX of the application as we recognize logos more easily than plain text. For example, if you have a delete button you can label it with a dustbin icon.

<Example path="Material-UI/button/examples/IconLabelButtons" />
...
<Example path="Material-UI/button/examples/IconButtons" />
