...
<Example path="Material-UI/radio-buttons/examples/RadioButtonsGroup" />

## Standalone Radio Buttons

`Radio` can also be used standalone, without the wrapper.

<Example path="Material-UI/radio-buttons/examples/RadioButtons" />

## Label placement

You can change the placement of the label:

<Example path="Material-UI/radio-buttons/examples/FormControlLabelPosition" />
